...
const Canlendar: React.FC<any> = ({ inView }) => {
  ...
  return (
    <Page onPageInit={onPageInit} onPageBeforeRemove={onPageBeforeRemove}>
      ...
      <Block>
        ...
        <p>
          Calendar could be used as inline component or as overlay. Overlay Calendar will be automatically converted to
          Popover on tablets (iPad).
        </p>
      </Block>
...
export default React.memo(Canlendar);
